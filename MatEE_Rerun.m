function time = MatEE_ReRun(runs)
    ...
    for i = 1:size(T,1)
        ...
        timeE = EE(cell2mat(T(i,1)), parameters, runs);
        time = [time timeE];
    end
end
...
%% EE
function timeE = EE(filename, parameters, runs)
...
%% Run EE
function timeE = runEE(filename_with_extension, X, y, params, runs)
