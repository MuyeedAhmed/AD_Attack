...
def ee(filename, optSettings):
    ...
    Default
    '''
    runEE(filename, X, gt, parameters_default, runs, 'Default', time[0][0])
...
def drawGraphs(filename, gt, labels, runs, mode):
    ...
    # plt.savefig("FlipFig/"+filename+"_MatEE_"+mode+"_FlippableVRun.pdf", bbox_inches="tight", pad_inches=0)
    # plt.show()
    ...
    # plt.savefig("FlipFig/"+filename+"_MatEE_"+mode+"_FlippableVRun_Percentage.pdf", bbox_inches="tight", pad_inches=0)
    # plt.show()
    '''
