...
if __name__ == '__main__':
    ...
    optSettings = optimalSettingsUni[optimalSettingsUni['Filename'] == 'ionosphere'].to_numpy()[0][1:]
    ...
    # g = plt.figure(figsize=(20, 5), dpi=80)
    # ax = df_def.plot.bar(x='Filename', y=['ti_fo_per_all','to_fi_per_all'], figsize=(20, 5), width=1, legend=None, xlabel="Dataset", ylabel="Flipped Points (%)")
    # # ax.patches[27].set_facecolor('red')
    ...
    # g = plt.figure(figsize=(20, 5), dpi=80)
    # ax = df_def.plot.bar(x='Filename', y=['ti_fo_per_avg','to_fi_per_avg'], figsize=(20, 5), width=1, legend=None, xlabel="Dataset", ylabel="Flipped Points (%)")
